...
{
    public partial class MedicalOperationForm : Form
    {
        public MedicalOperationForm()
        {
            InitializeComponent();
        }
        ...
        {
            string query = "SELECT * FROM [Smart Emargency System Bd].[dbo].[MedicalReports] ORDER BY ReportDate DESC";
        ...
        private void guna2Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string deleteQuery = "DELETE FROM [Smart Emargency System Bd].[dbo].[MedicalReports]  WHERE ReportId = @id";
                SqlConnection con = DBHelper.GetConnection();
        ...
        private void MedicalOperationForm_Load(object sender, EventArgs e)
        {
