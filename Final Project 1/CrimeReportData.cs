...
{
    public partial class CrimeReportData : Form
    {
        ...
        private void CrimeReportData_Load(object sender, EventArgs e)
        {
        ...
        {
            string query = "SELECT * FROM dbo.CrimeReports ORDER BY ReportDate DESC";
        ...
        private void guna2Button3_Click(object sender, EventArgs e)
        {
            ...
            {
                string deleteQuery = "DELETE FROM dbo.CrimeReports WHERE ReportId = @id";
                SqlConnection con = DBHelper.GetConnection();
